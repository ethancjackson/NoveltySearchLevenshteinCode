...
def evolve_solution(game_name, action_space_size, pop_size=1000+1, archive_p=0.01, archive_dump=None, n_generations=1000,
    ...
    for gen in range(starting_generation, n_generations):
        ...
        validation_pop = [result[0] for result in sorted(pop_trunc, key=lambda x: x[1])[-10:]]
...
action_space_size = env.action_space.n
env.close()
evolve_solution(game_name, action_space_size, pop_size=1000+1, archive_p=0.02, archive_dump=None,
                training_episodes=[0], T=100,
